...
const Login = () => {
    ...
    return (
        <section className="bg-gray-800 text-gray-100 h-full">
                ...
                <form onSubmit={handleLogin} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        ...
                        <input onBlur={e => setUserEmail(e.target.value)}
                            onChange={handleEmailChange} type="text" name="email" id="email" placeholder="email" className="w-full px-4 py-3 rounded-md text-black focus:dark:border-amber-400" />
